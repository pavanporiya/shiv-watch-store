    ...
    <PageWrapper>
      <div>
        <main id="main-content">
          ...
          {/* ABOUT BRAND */}
          <Reveal>
            <section className="section" aria-label="About Shiv Watch">
          ...
          {/* FEATURED */}
          <Reveal>
            <section className="section dark" aria-label="Featured Collection">
              ...
              <div className="featured-grid">
                <article
                  ...
                  aria-label="Explore Luxury Series Watch Collection"
                >
                  <ImageWithFallback
                    src="https://images.unsplash.com/photo-1524592094714-0f0654e20314"
                    alt="Luxury Series Watch preview"
                    loading="lazy"
                    decoding="async"
                  />
                ...
                <article
                  ...
                  tabIndex={0}
                  onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); navigate("/shop"); } }}
                  aria-label="Explore Sport Series Watch Collection"
                >
                  <ImageWithFallback
                    src="https://images.unsplash.com/photo-1622434641406-a158123450f9"
                    alt="Sport Series Watch preview"
                    loading="lazy"
                    decoding="async"
                  />
          ...
          {/* WHY US */}
          <Reveal>
            <section className="section dark" aria-label="Why Choose Us">
              <h2>Why Choose Us</h2>
              <div className="why-grid">
                <div><h3>Premium Quality</h3><p>Top-grade materials used in every watch</p></div>
                <div><h3>Fast Delivery</h3><p>Quick and reliable worldwide shipping</p></div>
                <div><h3>Secure Payments</h3><p>100% safe and trusted checkout</p></div>
              </div>
            </section>
          </Reveal>
          ...
          {/* TRUST */}
          <Reveal>
            <section className="trusted" aria-label="Brands We Feature">
              <h2>Trusted By</h2>
          ...
          {/* AVAILABILITY */}
          <Reveal>
            <section className="availability" aria-label="Global Availability">
        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <div>
              ...
              <p><Link to="/shop" style={{ color: "inherit", textDecoration: "none" }}>Shop</Link></p>
              <p><Link to="/orders" style={{ color: "inherit", textDecoration: "none" }}>Orders</Link></p>
            </div>
